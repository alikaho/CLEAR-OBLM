classdef BLM_GUI_APP < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function Plot_signal_beam_loss(app)
            ...
            % calling Find_fiber_loss_dist.m then
            ...
            app.is_plotting = true; % set that while the app is plotting, don't let this function begin again
            ...
            if strcmpi(app.OnOffRockerSwitch.Value,'Start') && app.idx_meas <= app.nb_meas && mod(app.idx_meas, 1) == 0
                ...
                if 0 <= beam_loss_dist && beam_loss_dist < 21.48
                    ...
                    beam_loss_pix = Distance_to_pixels_2(beam_loss_dist);
                    ...
                    plot(app.PositionPlotAxesPart1,[beam_loss_pix,beam_loss_pix],[-1,1],'LineWidth',10,"Color",[0 1 1 0.5])                          
                elseif beam_loss_dist >= 21.48 && beam_loss_dist <= 22.5 
                    ...
                    cla(app.PositionPlotAxesPart2)
                    plot(app.PositionPlotAxesPart1,[beam_loss_pix(1),beam_loss_pix(1)],[-1,1],'LineWidth',10,"Color",[0 1 1 0.5])
                    plot(app.PositionPlotAxesPart2,[beam_loss_pix(2),beam_loss_pix(2)],[-1,1],'LineWidth',10,"Color",[0 1 1 0.5])
                elseif beam_loss_dist < total_beam_length
                    % Convert this distance into pixels
                    beam_loss_pix = Distance_to_pixels_2(beam_loss_dist);                    
                    % plot the line of beam loss point for the second part of the beamline.
                    cla(app.PositionPlotAxesPart1)
                    plot(app.PositionPlotAxesPart2,[beam_loss_pix,beam_loss_pix],[-1,1],'LineWidth',10,"Color",[0 1 1 0.5])     
                else
                    cla(app.PositionPlotAxesPart2)
                    cla(app.PositionPlotAxesPart1)
                end
        ...
        function CalibrateButtonPushed(app, ~)
            ...
            BTV = {'CA.BTV0390','CA.BTV0620', 'CA.BTV0730','CA.BTV0810'};
            BTV_in = [int32(2), int32(1), int32(1), int32(1)]; %int32(2) looks like "SECOND", int32(1) looks like "FIRST"
            ...
            for i = 1:4
                ...
                % figs_signal.set_rasterized(True);
