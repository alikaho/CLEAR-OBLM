...
```
cd existing_repo
git remote add origin https://gitlab.cern.ch/CLEAR/clear-oblm.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.cern.ch/CLEAR/clear-oblm/-/settings/integrations)
